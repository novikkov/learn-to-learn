...
Footer - цвет, поля
footer-columns - flex,jus.space-between, width:90%;, margin:60 auto 40;
footer-column - 
copyrigth - position absolute - logo absol - aut absol
info - добав заголовок (шрифт+отступ)
link - 3 ссылки (блочный если <a>)
